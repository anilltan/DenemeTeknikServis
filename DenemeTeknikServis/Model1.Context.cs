...
namespace DenemeTeknikServis
{
    ...
    public partial class DbTeknikServisEntities1 : DbContext
    {
        ...
        public virtual DbSet<TBLURUNTAKIPP> TBLURUNTAKIPP { get; set; }
        ...
        public virtual ObjectResult<string> encokmarka()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("encokmarka");
        }
    }
}
